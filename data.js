...
export const PROFILE = {
  ...
  tagline: {
    en: "Computer Engineering student, comfortable across hardware and software. I pick things up fast and I like doing them properly.",
    vi: "Sinh viên Kỹ thuật Máy tính, làm được cả phần cứng lẫn phần mềm. Mình bắt nhịp nhanh và thích làm cho tử tế.",
  },
  // one honest line for the contact section
  availability: {
    en: "Open to internships. Point me at an interesting problem and I'll run with it.",
    vi: "Đang tìm cơ hội thực tập. Cứ giao một bài toán thú vị, mình sẽ theo tới cùng.",
  },
};
...
export const ABOUT = {
  en: [
    "I'm a Computer Engineering student at HCMUT who works comfortably across the stack — Verilog and FPGA, microcontrollers, backend and web, a bit of data work.",
    "Most of it started as coursework I took further than the assignment asked for, because I'd rather understand something fully than tick it off.",
    "What I'm confident about is picking up whatever a project needs and getting to useful quickly — which is most of what the work actually asks for.",
  ],
  vi: [
    "Mình là sinh viên Kỹ thuật Máy tính tại ĐH Bách Khoa, làm được thoải mái trên nhiều tầng — Verilog và FPGA, vi điều khiển, backend và web, một chút về dữ liệu.",
    "Phần lớn bắt đầu từ bài tập môn học mà mình làm xa hơn mức đề bài, vì mình thích hiểu tới nơi hơn là làm cho xong.",
    "Điều mình tự tin là bắt nhịp với thứ dự án cần và tới mức làm được thật nhanh — vốn cũng là phần lớn thứ công việc yêu cầu.",
  ],
};
...
export const APPROACH = {
  en: [
    ...
    { title: 'Ramp up fast',
      body: "Give me a new board, a new language, or an unfamiliar codebase and I get to useful quickly. That adaptability is the thing I lean on most." },
  ],
  vi: [
    ...
    { title: 'Bắt nhịp nhanh',
      body: "Đưa mình một board mới, một ngôn ngữ mới, hay một codebase lạ, mình tới mức làm được rất nhanh. Khả năng thích nghi đó là thứ mình dựa vào nhiều nhất." },
  ],
};
