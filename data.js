...
export const PROFILE = {
  ...
  roles: {
    en: ['a bit of everything', 'hardware and software', 'whatever the project needs'],
    vi: ['một chút mọi thứ', 'cả phần cứng lẫn phần mềm', 'thứ mà dự án cần'],
  },
  tagline: {
    en: "I'm a Computer Engineering student who hasn't picked one thing to specialize in yet. I build a bit of everything — hardware and software — and try to do each one properly.",
    vi: "Mình là sinh viên Kỹ thuật Máy tính, chưa chốt sẽ đi sâu vào mảng nào. Mình làm một chút mọi thứ — cả phần cứng lẫn phần mềm — và cố làm cho tử tế.",
  },
  // one honest line for the contact section
  availability: {
    en: "Third-year student, open to internships. Point me at something and I'll usually give it a go.",
    vi: "Sinh viên năm ba, đang tìm cơ hội thực tập. Giao gì mình cũng sẵn sàng thử.",
  },
};
...
export const ABOUT = {
  en: [
    "I'm a Computer Engineering student at HCMUT. I haven't settled on one area yet, so I've tried a fair range: Verilog and FPGA, microcontrollers, backend and web, a bit of data work.",
    "Most of it started as coursework I took further than the assignment asked for. I care more about doing each thing properly than about collecting labels for a CV.",
    "So if you want someone who'll pick up whatever the work needs and learn the rest as they go, that's the part I'm confident about.",
  ],
  vi: [
    "Mình là sinh viên Kỹ thuật Máy tính tại ĐH Bách Khoa. Mình chưa chốt đi sâu vào mảng nào, nên đã thử khá nhiều: Verilog và FPGA, vi điều khiển, backend và web, một chút về dữ liệu.",
    "Phần lớn bắt đầu từ bài tập môn học mà mình làm xa hơn mức đề bài yêu cầu. Mình quan tâm làm cho tử tế hơn là gom nhãn cho đẹp CV.",
    "Nên nếu cần một người sẵn sàng nhận việc gì cũng làm và tự học phần còn thiếu, thì đó là chỗ mình tự tin nhất.",
  ],
};
...
export const APPROACH = {
  en: [
    ...
    { title: 'Comfortable being the new person',
      body: "I am used to starting from not-knowing — a new board, a new language, a new codebase — and getting to useful reasonably fast. That is most of what an internship is anyway." },
  ],
  vi: [
    ...
    { title: 'Quen với việc là người mới',
      body: "Mình quen bắt đầu từ chỗ chưa biết — một board mới, một ngôn ngữ mới, một codebase lạ — và tới mức làm được khá nhanh. Thực tập về cơ bản cũng là vậy." },
  ],
};
